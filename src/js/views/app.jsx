...
export const App = () => {
    ...
    return (
        <div className="app">
            ...
            <h1 className="text-4xl tiny:text-6xl sm:text-7xl md:text-8xl font-black z-10 text-center absolute text-white top-[47%] left-1/2 -translate-x-1/2 -translate-y-1/2">
