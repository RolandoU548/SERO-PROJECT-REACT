    ...
    return (
        <div className="font-serif text-gray-200">
            ...
            <div className="glass rounded-2xl w-9/12 ml-40 mt-20 mb-16 flex justify-between">
                <div
                    className="invert cursor-pointer ease-out duration-300 hover:scale-105 w-80 bg-[url('../../../public/RobertoVargasCard.png')] bg-center bg-cover rounded-2xl h-[23rem] flex justify-center text-white text-3xl font-semibold border-2 border-white"
                    onClick={() => {
