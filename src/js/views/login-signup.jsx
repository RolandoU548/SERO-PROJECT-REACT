    ...
    return (
        <Base>
            <ReactCardFlip isFlipped={flip} flipDirection="vertical">
                {/* SIGNUP */}
                <div className="m-auto lg:my-4 my-20 w-[25rem] max-w-[95%] items-center glass py-10 px-8 resp:px-4 relative">
                    <BackArrow
                ...
                {/* LOGIN */}
                <div className="m-auto lg:my-20 my-20 w-[25rem] max-w-[95%] items-center glass py-10 px-8 resp:px-4 relative">
                    <BackArrow
